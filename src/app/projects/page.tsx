...
export const metadata: Metadata = { title: 'Websites and Design Work', description: 'Explore websites and design work for Blue Heron Café, OPA!, Northwest Tradesmen, and Cropper & Co.', alternates: { canonical: '/projects' } }
export default function Projects() {
  return <main id="main-content" className="inner-page">
    <section className="portfolio-section">
      <div className="work-heading">
        <h1>Websites and design work</h1>
